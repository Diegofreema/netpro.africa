...
export const story = {
  ...
  body: 'NetPro Africa Limited was incorporated in 2000 and has evolved into a customer-focused, Africa-oriented technology company serving institutions. What started as network infrastructure and software consultancy has grown into a full-spectrum platform company with AI-powered products for universities, polytechnics, hospitals, financial institutions, government agencies, cooperative societies, and business management teams.',
  stats: [
