...
export const blogHero = {
  ...
  body: 'At NETPRO Africa, we share practical notes from design, development, marketing, and technology delivery. Our blog gives founders, operators, and technical teams useful ideas they can apply to real projects.',
};
