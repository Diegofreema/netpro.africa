...
export const blogHero = {
  ...
  body:
    'At NETPRO Africa, we share practical notes from design, development, marketing, and technology delivery. Our blog gives founders, operators, and technical teams useful ideas they can apply to real projects.',
}

export const blogCategories: BlogCategory[] = ['All', 'Business', 'Design', 'Development']
...
export const blogPosts: BlogPost[] = [
  {
    ...
    body:
      'The most useful design trends are not decoration. They help teams explain value faster, reduce friction, and make interfaces easier to trust. This article looks at the design choices that improve readability, conversion, and long-term brand memory.',
    author: 'Laura Turner',
    authorInitials: 'LT',
    date: '15 / 01 / 2023',
    readTime: '6 minutes',
    image: assetUrl('/assets/netpro/logo-crop.png'),
    imageAlt: 'Netpro Africa brand mark on a dark textured card',
    featured: true,
  },
  {
    ...
    body:
      'Good design begins with the work people are trying to do. We outline practical ways to turn research, task flows, and feedback into clearer product decisions.',
    author: 'Daniel Lee',
    authorInitials: 'DL',
    date: 'March 2019',
    readTime: '6 min read',
  ...
  },
  {
    ...
    body:
      'Mobile conversion improves when screens are faster, forms are shorter, and the main action is always obvious. This piece covers layout, thumb reach, input design, and performance basics.',
  ...
  },
  {
    ...
    body:
      'Branding works when identity choices support the business promise. We explain how typography, spacing, color, imagery, and repetition affect trust.',
  ...
  },
  {
    ...
    body:
      'Minimal design is not empty design. It means hierarchy, contrast, and interaction states are doing the work with fewer competing elements.',
  ...
  },
  {
    ...
    body:
      'Before implementation begins, teams need agreement on workflows, permissions, migration needs, reporting, and support. This guide explains how to prepare.',
    author: 'Michael Ade',
    authorInitials: 'MA',
    date: 'April 2020',
    readTime: '7 min read',
...
export const blogCta = {
  ...
  description:
    "Take the first step towards digital success with NETPRO Africa by your side. Our team is eager to craft tailored solutions that move your project forward.",
