  ...
  return (
    <section className="np-project-hero relative overflow-hidden border-b border-white/8">
      <LightRays
        ...
        saturation={1}
      />
      <div className="np-container relative z-10 flex min-h-112 items-end pb-12 pt-28 sm:min-h-112 sm:pb-16 lg:pb-20">
        <div className="max-w-3xl" data-reveal="media">
          <h1 className="font-heading text-[clamp(2rem,9vw,4rem)] font-semibold leading-[1.06] tracking-tight text-foreground sm:tracking-[-0.03em]">
            {projectsHero.title}
          </h1>
          <p className="mt-5 max-w-2xl text-sm leading-6 text-muted-foreground sm:mt-6 sm:text-lg sm:leading-8">
            {projectsHero.summary}
          </p>
          <p className="mt-4 max-w-2xl text-sm leading-6 text-(--np-subtle) sm:mt-5 sm:text-base sm:leading-7">
