        ...
        <div className="np-card-texture overflow-hidden rounded-(--np-radius-xl) border border-white/10 px-5 py-5 shadow-(--np-shadow-soft) sm:px-7">
          <div className="relative z-10 flex flex-col gap-5">
            ...
            <div className="relative -mx-5 overflow-hidden sm:-mx-7">
              ...
              <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-14 bg-linear-to-l from-(--np-surface) to-transparent sm:w-20" />
                  ...
                  >
                    {trustedInstitutions.map((institution) => (
                      <div
                        ...
                        className="flex min-w-max items-center gap-3 rounded-full border border-white/10 bg-white/4 px-3.5 py-2.5 text-sm font-medium text-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] transition-[background-color,border-color] duration-(--np-duration-fast) hover:border-white/18 hover:bg-white/[0.07]"
                      >
                        <span className="grid size-9 shrink-0 place-items-center rounded-full border border-white/12 bg-white/8 text-xs font-semibold tracking-[0.08em] text-(--np-accent)">
